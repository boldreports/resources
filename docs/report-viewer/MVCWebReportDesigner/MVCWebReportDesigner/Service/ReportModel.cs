...
namespace MVCWebReportDesigner.Service
{
    public class StoreSales
    {
        ...
        public static List<StoreSales> GetData(string stateCode)
        {
            ...
            sales.Add(strSal);
            List<StoreSales> filteredData = new List<StoreSales>();
            if (!string.IsNullOrEmpty(stateCode))
            {
                filteredData = sales.Where(salesData => salesData.StateProvinceCode == stateCode).ToList();
                return filteredData;
            }
            return sales;
        }
    ...
    public class CustomerSales
    {
        ...
        public static List<CustomerSales> GetData(string stateCode)
        {
            ...
            customerSals.Add(cusSal);
            List<CustomerSales> filteredData = new List<CustomerSales>();
            if (!string.IsNullOrEmpty(stateCode))
            {
                filteredData = customerSals.Where(salesData => salesData.StateProvinceCode == stateCode).ToList();
                return filteredData;
            }
            return customerSals;
        }
